...
declare type CreateEntryParamsWithManagedResource<R extends ResourceTypeKeys, E extends ClientEntryMetadata = ClientEntryMetadata> = [defaultMetadata: DefaultMetadataWithOptionalResource<R>, payload: JsonPayload, entryMetadata: E];
declare type CreateLoggingClientEntryParams<R extends ResourceTypeKeys> = CreateEntryParamsWithManagedResource<R>;
export declare function createLoggingClientEntry<R extends ResourceTypeKeys>(...params: CreateLoggingClientEntryParams<R>): {
    metadata: {
...
declare type CreateStandardEntryParamsWithManagedResource<R extends ResourceTypeKeys> = CreateEntryParamsWithManagedResource<R, Required<ClientEntryMetadata, 'logName'>>;
declare type CreateStandardEntryParams<R extends ResourceTypeKeys> = CreateStandardEntryParamsWithManagedResource<R>;
export declare function createStandardEntry<R extends ResourceTypeKeys = DefaultResourceKey>(...params: CreateStandardEntryParams<R>): {
    logName: string | undefined;
    severity?: "DEFAULT" | "DEBUG" | "INFO" | "NOTICE" | "WARNING" | "ERROR" | "CRITICAL" | "ALERT" | "EMERGENCY" | undefined;
    ...
    timestamp?: Date | undefined;
    'logging.googleapis.com/insertId'?: string | undefined;
    ...
    'logging.googleapis.com/trace_sampled'?: boolean | undefined;
