...
exports.mergeLabels = exports.log = exports.convertDurationToString = exports.formatHttpRequest = exports.createFullyQualifiedIdentifier = exports.validateProjectId = exports.formatMessage = exports.convertErrorToMessage = exports.convertClientMetadataToStdMetadata = void 0;
...
exports.formatHttpRequest = formatHttpRequest;
function convertDurationToString(duration) {
    ...
    if (typeof duration.nanos === 'number' && duration.nanos > 0) {
        nanosString = `${String(mathjs_1.format(duration.nanos / 10 ** 9, { notation: 'fixed' })).split('.')[1] ?? 0}`;
    }
