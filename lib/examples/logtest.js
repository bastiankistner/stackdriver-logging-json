...
const { clientEntry: { metadata, data }, stdEntry, } = entry_1.createSampleEntry();
async function writeToClient() {
    const entry = new logging_1.Entry(metadata, data);
...
async function writeToFluentBit() {
    ...
    const body = format_1.standardEntryToFluentBit130Entry(stdEntry);
